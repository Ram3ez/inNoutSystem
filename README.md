...
*   **`timestamp` (String)**: IST-formatted transaction time.
*   **`action` (String)**: High-level category (e.g., `STAFF_ASSIGN_ADD`).
*   **`message` (String)**: Human-readable description of the event.
*   **`user_id` / `user_name`**: Identity of the administrator who performed the action.
