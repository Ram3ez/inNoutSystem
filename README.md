...
*   Stores high-dimensional floating-point arrays (vectors) generated by GhostFaceNet and EdgeFace respectively. Used for the client-side, offline-first biometric cache.
